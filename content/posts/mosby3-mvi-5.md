---
title: "Reactive Apps with Model-View-Intent - Part 5: Debugging with ease"
date: 2017-03-17T10:00:00+01:00
description: "Model-View-Intent MVI on Android by using Mosby 3. Focusing on Debugging and time traveling in MVI on Android."
type: "post"
url: "android/mosby3-mvi-5"
categories: 
  - "Android"
tags:
  - "android"
...
In [part 1]({{< ref mosby3-mvi-1.md >}}) we have talked about the importance of
...
Let's do that for the home screen by adding logs in the **HomePresenter** (for more details about this class see [part 3]({{< ref mosby3-mvi-3.md >}}) where we have discussed the advantages of a state reducer).
