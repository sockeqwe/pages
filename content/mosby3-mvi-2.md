...
In the [first part]({{< ref mosby3-mvi-1.md >}}) we have discussed what a Model actually is,
...
If you haven't read [part 1]({{< ref mosby3-mvi-1.md >}}) yet, you should read that before continue with this blog post. To summarize:
...
Please node that `SearchView::searchIntent` is just a Java 8 shorthand for `searchView.searchIntent()`
