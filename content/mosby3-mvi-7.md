---
title: "Reactive Apps with Model-View-Intent - Part 7: Timing (SingleLiveEvent problem)"
date: 2017-09-13T10:00:00+01:00
description: "Model-View-Intent MVI on Android by using Mosby 3. How MVI solves the SingleLiveEvent problem"
type: "post"
url: "android/mosby3-mvi-7"
categories: 
  - "Android"
tags:
  - "android"
...
Then we use a [State Reducer]({{< ref mosby3-mvi-3.md >}}) to compute the View State (`scan()` operator).
